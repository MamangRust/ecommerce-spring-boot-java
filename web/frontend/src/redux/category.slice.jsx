...
export const createCategory = createAsyncThunk(
  ...
  async (categoryData, { getState, rejectWithValue }) => {
    try {
      ...
      const response = await myApi.post('/categories/create', categoryData, {
        headers: {
...
export const updateCategory = createAsyncThunk(
  ...
  async ({ id, categoryData }, { getState, rejectWithValue }) => {
    try {
      ...
      const response = await myApi.put(`/categories/${id}`, categoryData, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
...
export const deleteCategory = createAsyncThunk(
  ...
  async (id, { getState, rejectWithValue }) => {
    try {
      const token = getState().loginReducer.token;
      await myApi.delete(`/categories/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
...
export const fetchCategoryBySlug = createAsyncThunk(
  ...
  async (slug, { rejectWithValue }) => {
    try {
      const response = await myApi.get(`/categories/slug/${slug}`);
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response.data);
    }

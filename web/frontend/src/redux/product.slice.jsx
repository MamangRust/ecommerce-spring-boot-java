...
export const fetchProductById = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      const response = await myApi.get(`/products/${id}`);
      return response.data.data;
    } catch (error) {
      return rejectWithValue(error.response.data);
    }
...
export const fetchProductBySlug = createAsyncThunk(
  ...
  async (slug, { rejectWithValue }) => {
    try {
      const response = await myApi.get(`/products/${slug}`);
...
export const createProduct = createAsyncThunk(
  ...
  async (productData, { rejectWithValue, getState }) => {
    try {
      ...
      const response = await myApi.post(`/products/create`, productData, {
        headers: {
...
export const updateProductById = createAsyncThunk(
  ...
  async ({ id, form }, { rejectWithValue, getState }) => {
    try {
      const token = getState().auth.token;
      const response = await myApi.put(`/products/${id}`, form, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
...
export const deleteProductById = createAsyncThunk(
  ...
  async (id, { rejectWithValue, getState }) => {
    try {
      const token = getState().auth.token;
      await myApi.delete(`/products/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });

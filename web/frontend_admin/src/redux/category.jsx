...
export const fetchCategoryById = createAsyncThunk(
  ...
  async (id, { getState, rejectWithValue }) => {
    try {
      ...
      const response = await myApi.get(`/categories/${id}`, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      });
...
export const createCategory = createAsyncThunk(
  ...
  async (createCategory, { getState, rejectWithValue }) => {
    try {
      const { accessToken } = getState().loginReducer;
      const response = await myApi.post('/categories/create', createCategory, {
        headers: {
...
export const updateCategoryById = createAsyncThunk(
  ...
  async (formData, { rejectWithValue, getState }) => {
    try {
      ...
      const response = await myApi.post(`/categories/update`, formData, {
        headers: {
          'Content-Type': 'multipart/form-data',
          Authorization: `Bearer ${accessToken}`,
        },
...
export const deleteCategoryById = createAsyncThunk(
  ...
  async (id, { rejectWithValue, getState }) => {
    try {
      ...
      const response = await myApi.delete(`/categories/${id}`, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      });
